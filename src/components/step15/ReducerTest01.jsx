...
// useReducer 는 React 의 상태관리 훅, 복잡한 상태 변화를 더 명확하고 예측 가능하게 관리할 수 있도록 도와준다.
// 상태관리 로직을 컴포넌트에서 분리하여 코드 가독성을 높인다.

// reducer  -> state를 업데이트하는 함수
// dispatch -> state 업데이트를 위한 요구
// action   -> 요구의 내용 , type 와 payload 가 있다.
...
function ReducerTest01(props) {
  ...
  return (
    <div>
      <p> Count : {number} </p>
      {/* 구분하기 위해서 type가 존재한다. payload : 액션이나, 요청에 포함되는 데이터 또는 정보를 의미 */}
